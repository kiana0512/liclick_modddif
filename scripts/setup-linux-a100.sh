...
FEISHU_OAUTH_SCOPE="${FEISHU_OAUTH_SCOPE:-openid profile email}"
...
IDAAS_JWT_SSO_URL="${IDAAS_JWT_SSO_URL:-https://idaas.lilith.com/enduser/sp/sso/lilithplugin_jwt57}"
