...
- If a placeholder must be clickable, keep the handler local to the owning component and dedupe the toast there.
...
- Mock layers no longer seed the active editor layer store, and the old unused mock layer/reference files have been removed.
